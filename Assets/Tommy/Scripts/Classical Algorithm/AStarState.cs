...
namespace Tommy.Scripts.Classical_Algorithm
{
    ...
    //         unchecked
    //         {
    //             Vector3Int thisPose = Vector3Int.RoundToInt(pose);
    //             int hash = 17;
    //             hash = hash * 23 + thisPose.x.GetHashCode();
    //             hash = hash * 23 + thisPose.y.GetHashCode();
    //             hash = hash * 23 + thisPose.z.GetHashCode();
    //             return hash;
    //         }
    //     }
    // }
